	...
	<div class="card-panel">
    	<div class="row">';
			...
			echo'<div class="col m9">';
				echo"<div class='bread'><a href='./mercato.php'>Gestione</a> / Calendario</div><br>
				<div class='card'>
...
for($num1 = 0 ; $num1 < $num_campionati; $num1++) {
	...
	if ($tipo_campionato != "N") {
		...
		echo"<span class='card-title'>Calendario<span style='font-size: 13px;'> - Campionato dalla giornata <b>$g_inizio_camp</b> alla <b>$g_fine_camp</b></span></span>
			 	        <hr>";
