			...
			echo'<div class="col m9">';
				...
				<div class='card'>
				    <div class='card-content'>
				        <span class='card-title'>Riepilogo rosa<span style='font-size: 13px;'> - Dati statistici fino alla giornata $ultima_giornata</span></span>
			 	        <hr>";
				
                             echo"<table style='width:100%'>";

		$tabella = "<table  class='mdl-data-table mdl-shadow--2dp' width='100%' cellpadding='0' cellspacing='0' align='center' bgcolor='$sfondo_tab' summary='Tabella statistiche squadra'>
		<tr>
		<td class='testa'>Nome</td>
		<td class='testa'>Team</td>
		<td class='testa'>Gare</td>
		<td class='testa'>Medie</td>
...
*/
				if ($statistiche == "SI") {
					...
					$squadra = "<a href='tab_squadre.php?vedi_squadra=$stat_squadra' style=' border: 0px; text-decoration: none;' title='$stat_squadra'><img style='border-radius: 12px;' src='./immagini/$lmsquadra' style='width: 25px; border: 0px; text-decoration: none;' alt='$stat_squadra' /></a>";

					$tabella .= "<tr bgcolor='$color'>
					<td class='mdl-data-table__cell--non-numeric'><b>$ruolo</b> - <a href='stat_calciatore.php?num_calciatore=$numero&amp;ruolo_guarda=$ruolo_guarda' class='user'>$nome</a> $csattivo</td>
					<td align='center'>$squadra</td>
					<td align='center'>$totpresenze</td>
					<td align='center'>$media_punti ($media_giornale)</td>
					...
					<td align='center'>$valore / $stat_valore</td>
