<?php
	...
	*/
	...
	$xsquadra_ok = "NO";
	$controlla_squadra = "";
	if ($np == substr($verifica_sg,0,1))  $controlla_squadra .= "<td style='width: 25%;'><p class='ruolotab'>Portieri</p><b><p class='numtab'>$np / ".substr($verifica_sg,0,1)."</b></p><center><p class='btn waves-effect waves-light green white-text'>Al completo</p></center></td>";
	elseif ($np > substr($verifica_sg,0,1)) $controlla_squadra .= "<td><p class='ruolotab'>Portieri:</p> <p class='numtab'><font color='red'><b>$np</b></font> / ".substr($verifica_sg,0,1)." </p><center><p class='btn waves-effect waves-light red white-text'>Vendere esubero</p></center></td>";
	elseif ($np < substr($verifica_sg,0,1)) $controlla_squadra .= "<td style='width: 25%;'><p class='ruolotab'>Portieri</p><p class='numtab'>$np / ".substr($verifica_sg,0,1)." </p><center><a class='btn waves-effect waves-light indigo' href='tab_calciatori.php?ruolo_guarda=P&amp;xsquadra_ok=NO&amp;mercato_libero=$mercato_libero' class='user'>Acquista</a></center></td>";
	
	if ($nd == substr($verifica_sg,1,1))  $controlla_squadra .= "<td style='width: 25%;'><p class='ruolotab'>Difensori</p><b><p class='numtab'>$nd / ".substr($verifica_sg,1,1)."</b></p><center><p class='btn waves-effect waves-light green white-text'>Al completo</p></center></td>";
	elseif ($nd > substr($verifica_sg,1,1)) $controlla_squadra .= "<td><p class='ruolotab'>Difensori:</p> <p class='numtab'><font color='red'><b>$np</b></font> / ".substr($verifica_sg,1,1)." </p><center><p class='btn waves-effect waves-light red white-text'>Vendere esubero</p></center></td>";
	elseif ($nd < substr($verifica_sg,1,1)) $controlla_squadra .= "<td style='width: 25%;'><p class='ruolotab'>Difensori</p><p class='numtab'> $nd / ".substr($verifica_sg,1,1)."</p><center><a class='btn waves-effect waves-light indigo' href='tab_calciatori.php?ruolo_guarda=D&amp;xsquadra_ok=NO&amp;mercato_libero=$mercato_libero' class='user'>Acquista</a></center></td>";
	
	if ($nc == substr($verifica_sg,2,1))  $controlla_squadra .= "<td style='width: 25%;'><p class='ruolotab'>Centrocampisti</p><b><p class='numtab'>$nc / ".substr($verifica_sg,2,1)."</b></p><center><p class='btn waves-effect waves-light green white-text'>Al completo</p></center></td>";
	elseif ($nc > substr($verifica_sg,2,1)) $controlla_squadra .= "<td><p class='ruolotab'>Centrocampisti:</p> <p class='numtab'><font color='red'><b>$np</b></font> / ".substr($verifica_sg,2,1)." </p><center><p class='btn waves-effect waves-light red white-text'>Vendere esubero</p></center></td>";
	elseif ($nc < substr($verifica_sg,2,1)) $controlla_squadra .= "<td style='width: 25%;'><p class='ruolotab'>Centrocampisti</p><p class='numtab'>$nc / ".substr($verifica_sg,2,1)."</p><center><a class='btn waves-effect waves-light indigo' href='tab_calciatori.php?ruolo_guarda=C&amp;xsquadra_ok=NO&amp;mercato_libero=$mercato_libero' class='user'>Acquista</a></center></td>";
	
	if ($considera_fantasisti_come == "F") {
	if ($nf == substr($verifica_sg,3,1))  $controlla_squadra .= "<td style='width: 25%;'><p class='ruolotab'>Fantasisti</p><b><p class='numtab'>$nf / ".substr($verifica_sg,3,1)."</b></p><center><p class='btn waves-effect waves-light green white-text'>Al completo</p></center></td>";
	elseif ($nf > substr($verifica_sg,3,1)) $controlla_squadra .= "<td><p class='ruolotab'>Fantasisti:</p> <p class='numtab'><font color='red'><b>$np</b></font> / ".substr($verifica_sg,3,1)." </p><center><p class='btn waves-effect waves-light red white-text'>Vendere esubero</p></center></td>";
	elseif ($nf < substr($verifica_sg,3,1)) $controlla_squadra .= "<td style='width: 25%;'><p class='ruolotab'>Fantasisti</p><p class='numtab'>$nf / ".substr($verifica_sg,3,1)."</p><center><a class='btn waves-effect waves-light indigo' href='tab_calciatori.php?ruolo_guarda=F&amp;xsquadra_ok=NO&amp;mercato_libero=$mercato_libero' class='user'>Acquista</a></center></td>";
	}
	
	if ($na == substr($verifica_sg,4,1)) $controlla_squadra .= "<td style='width: 25%;'><p class='ruolotab'>Attaccanti</p><b><p class='numtab'>$na / ".substr($verifica_sg,4,1)."</b></p><center><p class='btn waves-effect waves-light green white-text'>Al completo</p></center></td>";
	elseif ($na > substr($verifica_sg,4,1)) $controlla_squadra .= "<td><p class='ruolotab'>Attaccanti:</p> <p class='numtab'><font color='red'><b>$np</b></font> / ".substr($verifica_sg,4,1)." </p><center><p class='btn waves-effect waves-light red white-text'>Vendere esubero</p></center></td>";
	elseif ($na < substr($verifica_sg,4,1)) $controlla_squadra .= "<td style='width: 25%;'><p class='ruolotab'>Attaccanti</p><p class='numtab'>$na / ".substr($verifica_sg,4,1)."</p><center><a class='btn waves-effect waves-light indigo' href='tab_calciatori.php?ruolo_guarda=A&amp;xsquadra_ok=NO&amp;mercato_libero=$mercato_libero' class='user'>Acquista</a></center></td>";
	} # fine if $xsquadra_ok
	...
	if ($stato_mercato == "I") echo " <b>Fase iniziale</b><br /><br />";
	elseif ($stato_mercato == "C") echo " <b>Stato mercato:</b> Chiuso<br /><br />";
	elseif ($stato_mercato == "S") echo " <b>Stato mercato:</b> Sospeso<br /><br />";
	elseif ($stato_mercato == "P") echo " <b>Stato mercato:</b> Asta Perenne<br /><br />";
	elseif ($stato_mercato == "B") echo " <b>Stato mercato:</b> Buste Chiuse<br /><br />";
	elseif ($stato_mercato == "A") echo " <b>Stato mercato:</b> Aperto<br /><br />";
	elseif ($stato_mercato == "R") echo " <b>Stato mercato:</b> Riparazione<br /><br />";
	...
	<tr>	
	<td colspan='2'><center><b>Crediti disponibili:</b> $soldi_spendibili</center></td>	
	<td colspan='2'><center><b>Giocatori da acquistare:</b> $num_calciatori_comprabili</center></td>	
	</tr>	
	<tr>	
	$controlla_squadra	
	</tr>			
